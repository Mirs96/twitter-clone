...
public class DisplayTweetDto {
    ...
    public DisplayTweetDto(long id, long userId, String userNickname, String content, String creationDate, String creationTime, long likeCount, long replyCount, long bookmarkCount) {
        this.id = id;
        this.userId = userId;
